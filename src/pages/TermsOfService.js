      ...
      <div style={{ padding: "20px 24px", paddingBottom: 40 }}>
        ...
        {[
          ...
          },
          {
            ...
            content: `${APP} offers the following plans: Free (no charge), Premium ($9.99/month), and Stylist Subscription ($20/month or $200/year). Stylists set their own booking rates for client sessions. All payments are processed securely through Stripe. Subscriptions automatically renew unless cancelled before the renewal date. You may cancel at any time through your Account settings. Refunds are issued at our discretion.`
          },
          {
